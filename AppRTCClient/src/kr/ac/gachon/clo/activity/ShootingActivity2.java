...
public class ShootingActivity2 extends Activity {

	private static final String TAG = ShootingActivity2.class.getSimpleName();
	private CameraView shootingView;
	...
	ImageView btnPlay;
	ImageView btnLike;
	public TextView shootTitle, txtPop;
...
//	}
	...
	protected void onStart() {
		...
		// PeerConnectionGenerator.getInstance().createPeerConnection();
	}
